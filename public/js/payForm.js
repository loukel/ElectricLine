...
// Init stripe
var stripe = Stripe('pk_test_51IMFuXCd6Q7iPk8RE2IyGxA2eNyVC7UDJnWWZz11eoPKDZpmDSpfQMLdmSIrfoYkYgwOlldBwmufiZAVcNM3ech500OKjQ4a7m');
...
cardElement.mount('#card-element'); // Get card elements

var cardHolderName = document.getElementById('card-holder-name');
var cardButton = document.getElementById('card-button'); // Validate the card input
...
cardButton.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var _yield$stripe$createP, paymentMethod, error, hiddenInput;
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/payForm.js");
